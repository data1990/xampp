<div class="box box-info">
  <div class="box-header">
    <h3 class="box-title">Sửa bài viết
      <small> </small>
    </h3>
    <!-- tools box -->
  ...
  <div class="box-body pad">
    <form method="post">
          <div class="form-group">
            ...
            <input type="text" name="tieude" class="form-control" placeholder="Nhập Tiêu đề" value="<?php echo $row->tieude ?>">
          </div>
          <label for="exampleInputEmail1">Nội dung</label>
          <textarea id="editor1" name="noidung" rows="10" cols="80"><?php echo $row->noidung ?>  </textarea>

          <div class="form-group">
            <label>Chuyên mục</label>
            <select name="chuyenmuc" class="form-control">
              <option value="0">Lựa chọn</option>
              <?php foreach($listcm as $rowcm){ ?>
                <option value="<?php echo $rowcm->id; ?>" <?php echo ($rowcm->id==$row->idcm)? "selected":"" ?> > <?php echo $rowcm->tencm ?></option>
              <?php  } ?>
