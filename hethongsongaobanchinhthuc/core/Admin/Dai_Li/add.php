                ...
                if(mysqli_query($conn, $payment)){
                    ...
                    if (mysqli_query($conn, $minus)) {
                        ...
                        if(mysqli_query($conn, $his)){
                            echo "<script>alert('Đăng kí thành công, tài khoản này chưa đươc kích hoạt, quản lí lại mục Quản lí Đại Lí!');window.location='index.php?vip=List_Agency';</script>";
                        }
                    }
                }
            }
