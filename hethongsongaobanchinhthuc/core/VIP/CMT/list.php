...
<div class="box wow fadeIn">
    <div class="box-header">
        <h3 class="box-title">Danh sách ID VIP CMT <?php if($rule == 'admin' || $rule == 'agency'){ ?> | <a class="btn btn-danger" href="index.php?vip=CTV_CMT" target="_blank">VIP CMT CTV</a><?php } ?></h3>
    </div>
    <!-- /.box-header -->
