                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                     <b>VIP LIKE SEVER 1</b>
                                        <br><?php
                                        if($getsetting['viplike'] == 'on'){ echo 'Hoạt động';}else{
                                            echo 'Không Nhận ID';
                                        }
                                        ?>
                                    </div>
                                    ...
                                    <div class="panel-footer">
                                             <a href="index.php?vip=Add_VIP_Like_SV1" class="btn btn-success"><i class="fa fa-plus-circle" aria-hidden="true"></i> MUA</a>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                     <b>VIP LIKE SEVER 2</b>
                                        <br><?php
                                        if($getsetting['viplike2'] == 'on'){ echo 'Hoạt động';}else{
                                            echo 'Không Nhận ID';
                                        }
                                        ?>                                    </div>
                                    <div class="panel-body">
